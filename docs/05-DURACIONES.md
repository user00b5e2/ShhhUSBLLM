...
Modelos: familia Qwen2.5-Coder Q4_K_M.

## Por slot

### Slot 1 (1.5B-Coder agent — fast lane)
...
### Slot 4 (1.5B-Coder chat)

| Tarea | Tiempo |
|-------|--------|
| Carga inicial | 20–40 s |
| Respuesta corta | 8–18 s |
| Respuesta larga | 1–2 min |

### Slot 5 (7B-Coder agent — tareas grandes)
...
Suposiciones: el MD detalla 5 ficheros (~200 líneas/cada uno) que deben compilar entre sí. Con Qwen2.5-Coder-7B en CPU 8 GB sin GPU.
...
- Si el modelo se atasca en alguna iteración: hasta 60 min antes de agotar `MaxIter=20`.
...
| Slot 1 / 4 cargado | 1.3 GB | 30 MB | baseline + 1.3 GB |
| Slot 2 / 3 cargado | 2.4 GB | 30 MB | baseline + 2.4 GB |
...
4. **Apagar Defender realtime scanning** durante la tarea baja overhead un 10–20 %. No lo hagas de rutina; sí en una sesión de trabajo controlada.
5. **Usar inglés en los prompts** con slot 1: el 1.5B comprende mejor inglés que español. Slot 2 y 5 manejan español decentemente.
