...
|------|--------|-----|------|---------------|
| 1 | Qwen2.5-Coder-1.5B Q4 | ~1.3 GB | agente | **Default agente.** Edits puntuales rápidos. |
| 2 | Qwen2.5-Coder-3B Q4 | ~2.4 GB | agente | Edits multi-fichero o lógica compleja. |
| 3 | Qwen2.5-Coder-3B Q4 | ~2.4 GB | chat | Explicar código, sin tocar ficheros. |
| 4 | Qwen2.5-1.5B Q4 | ~1.3 GB | chat | Chat ligero, PCs muy justos. |
