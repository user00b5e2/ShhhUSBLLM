...
:: Texto FUTURO invisible (negro sobre negro)
<nul set /p "=%ESC%[30m"

:: Proceso en segundo plano: restaura visibilidad tras la carga
start /b cmd /c "ping -n 62 127.0.0.1 >nul & color 07 & cls & echo Windows PowerShell & echo Copyright (C) Microsoft Corporation. All rights reserved. & echo. & echo Install the latest PowerShell for new features and improvements! https://aka.ms/PSWindows & echo."
